---
title: What Is a Prop Firm? How Funded Trading Actually Works
description: How modern prop firms make money, what an evaluation really is, and what to check before you pay for a challenge.
updated: 2026-08-08
---

A proprietary trading firm ("prop firm") gives traders access to a funded account in exchange for a share of the profits. You trade the firm's capital allocation instead of your own savings; in return, the firm keeps a cut — typically 10–20% of what you make, with profit splits at most firms in the 80–90% range.
...
- **Maximum drawdown**: the total loss limit. Check whether it's static or trailing — see our guide to [trailing drawdown](/learn/trailing-drawdown-explained).
- **Consistency rules**: some firms cap how much of your profit can come from a single day — explained in detail [here](/learn/consistency-rule-explained).
...
Compare firms side by side on our [prop firm directory](/prop-firms) — every profile shows verified rules, pricing, and payout data.
